...
const About = () => {
    return (
        <div>
            <div>
                <h1>WELCOME TO AZURE<span className="text-green-500">HORIZON</span></h1>
    ...
    <h1>FAQ</h1>
                <p>Explore our FAQ section to discover answers to commonly asked questions about AzureHorizon. Whether you're curious about our booking process, amenities offered, or cancellation policies, we've got you covered. Find out more about our luxurious accommodations, exclusive services, and stunning locations to ensure your experience with AzureHorizon exceeds your expectations. Can't find what you're looking for? Don't hesitate to reach out to our dedicated support team for personalized assistance. Your journey to unparalleled luxury starts here.</p>
		<div className="space-y-4">
			<details className="w-full border rounded-lg">
				<summary className="px-4 py-6 focus:outline-none focus-visible:dark:ring-violet-600"> How do I book a villa, penthouse, or resort with AzureHorizon?
			...
			<details className="w-full border rounded-lg">
				<summary className="px-4 py-6 focus:outline-none focus-visible:dark:ring-violet-600">What amenities are included in your villas and penthouses?
			...
			<details className="w-full border rounded-lg">
				<summary className="px-4 py-6 focus:outline-none focus-visible:dark:ring-violet-600">Can I cancel my reservation with AzureHorizon, and what is the cancellation policy?
			...
			<details className="w-full border rounded-lg">
				<summary className="px-4 py-6 focus:outline-none focus-visible:dark:ring-violet-600">Where are AzureHorizon properties located?
